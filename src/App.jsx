...
const ContributorGrid = () => {
  ...
  const contributors = [
   ...
   ...Array(49).fill({ name: "Shrikar", imageUrl: "https://github.com/YourIPaddress/Open-source-session/blob/main/public/images/My%20face%20lol.jpeg" }) // Fill the rest with empty boxes
  ];
